...
void sequential_transmit_sensor_data(void) {
  ...
  // case 0:
  //   sprintf(data, "temp=%f,baro=%f,f=%u", bmp390_temperature,
  //   bmp390_pressure,
  //           bmp390_fault_count);
  //   break;
  // case 1:
  ...
  //   break;
  // case 3:
  //   sprintf(data, "gyro_x=%f,gyro_y=%f,gyro_z=%f", bno085_gyro_x,
  //   bno085_gyro_y,
  //           bno085_gyro_z);
  //   break;
  // case 4:
  ...
  // xbee_sensor_data_transmit_index = (xbee_sensor_data_transmit_index + 1) %
  // 8;
}
